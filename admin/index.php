...
echo "<tr>
        ...
        <td><input type='text' class='input-medium search-query field-narrow' name='probe_active' value='".$probe_active."'/></td>
        <td><input type='text' class='input-medium search-query field-wide' name='probe_hostport' value='".$probe_hostport."'/></td>
...
echo "<tr>
        ...
        <td><input type='text' class='input-medium search-query field-wide' name='probe_hostport'/></td>
