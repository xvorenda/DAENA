...
echo "
    <div id='about'>
        <h1 class='custom-font'>About DAENA</h1>
        ...
        <h1>Contact Us</h1>
        <p>If you have questions, comments, or suggestions, please email me at <a href='mailto:xvorenda@vcu.edu'>xvorenda@vcu.edu</a>.</p>
    </div>";
