...
/* Draw Alarm Mod Area */
echo "
<style>.dygraph-title{font-size:12px!important;margin:auto!important;width:100%!important}</style>
    ...
    $freezer_loc = preg_replace($pattern,"",$freezer_loc);
          ...
          echo "<tr class='alarm-table-row'>
              <form action='handlers/alarm-mod.php' method='POST'>
                ...
                echo "<td><span class='glyphicon glyphicon-chevron-down purple'></span></td>";
              } elseif ($last_temp_now == $last_temp_then) {
